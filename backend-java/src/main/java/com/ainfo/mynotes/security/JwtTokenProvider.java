...
public class JwtTokenProvider {
    ...
    public Authentication getAuthentication(String token) {
        UserDetails userDetails = notesUserDetailsService.loadUserByUsername(getUsername(token));
    ...
    public boolean validateToken(String token) {
        try {
            ...
            throw new MyNoteException("Expired or invalid JWT token, please logout !", HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
